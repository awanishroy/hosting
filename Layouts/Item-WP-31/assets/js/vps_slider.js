...
var cpu_arr = new Array('1.60 GHZ','2GB','4.20 GHZ','4.40 GHZ','4.80 GHZ');
var ram_arr = new Array('2 GB','2 Core(s)','8 GB','12 GB','16 GB');
var hdd_arr  = new Array('10 GB','30 GB','50 GB','60 GB','80 GB');
var bandwidth_arr = new Array('Unlimited','3TB','Unlimited','Unlimited','Unlimited');
var ip_arr = new Array('3 IPs', '5 IPs','7 IPs','9 IPs','Unlimited')
var price_arr = 	new Array('$2.50','$19.99','$5.50','$7.50','$8.50');
